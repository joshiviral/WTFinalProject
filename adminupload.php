...
$comment = $_REQUEST["des"];
   ...
   $result = mysqli_query($con,"INSERT INTO image_table (username,folder,name,comment,time,flag) VALUES ('Admin','$filepath','$filename','$comment','$curr_date',1)");
    }
...
<html lang="en">
<head>
  <title>TravelPedia | Admin Post</title>
  <meta charset="utf-8">
